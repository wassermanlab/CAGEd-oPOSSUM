...
=head1 DESCRIPTION
  ...
  Update 2014/12/1
  Latest OBO file used was ff-phase1-prerelease-20130717.obo (19-Feb-2014)
  ...
  Human
    /devel/FANTOM5_oPOSSUM/scripts/util/prune_ontology.pl -s human
        -f ff-phase1-prerelease-20130717.obo -h hg19_pruned_ontology.html
        -m hg19_pruned_ontology.missing.txt
 
  Mouse
    /devel/FANTOM5_oPOSSUM/scripts/util/prune_ontology.pl -s mouse
        -f ff-phase1-prerelease-20130717.obo -h hg19_pruned_ontology.html
        -m hg19_pruned_ontology.missing.txt
