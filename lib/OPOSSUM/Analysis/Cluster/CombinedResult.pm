...
result of a Fisher, Z-score and KS analysis for a single TFBS cluster
...
=head2 new
 ...
 Args     : id              - Result ID, i.e. the TFCluster ID
            t_seq_hits     - Number of genes in the target set which had
                              at least one binding site for this TF
            t_seq_no_hits  - Number of genes in the target set which did
                              not have at least one binding site for this
                              TF
            bg_seq_hits    - Number of genes in the background set which
                              had at least one binding site for this TF
            bg_seq_no_hits - Number of genes in the background set of
